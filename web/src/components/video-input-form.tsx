...
export function VideoInputForm(props: VideoInputFormProps) {
  ...
  return (
    ...
    <label 
      htmlFor="video"
      className="relative flex flex-col gap-2 items-center justify-center text-muted-foreground border border-dashed rounded-md aspect-video cursor-pointer text-sm hover:bg-primary/5"
    >
      {previewURL ? (
